...
import { RegisterForm } from "@/lib/components/ui/signup-form";
          ...
          <div className="space-y-10">
            ...
            <div className="max-w-md space-y-4">
              ...
              <h1 className="text-4xl font-semibold leading-tight">
                Create a FoodNest account in a few details.
              </h1>
              <p className="text-sm leading-6 text-white/70">
                Register once, then continue from the role-based dashboard after
                sign in.
              </p>
            </div>
          </div>
